...
- **[Add Person, Teachers, and Students ]**
- **[Add new books]**
...
```sh
  git clone https://github.com/Masuduzzaman811/OOP-School-Library.git
```
...
Feel free to check the [issues page](https://github.com/Masuduzzaman811/OOP-School-Library/issues).
...
If you like this project, give a start to my github repo and for any suggestion, open an issue.
